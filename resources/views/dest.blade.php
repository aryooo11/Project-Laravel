...
<section class="section" id="popular">
    <div class="container">
        <span class="section__subtitle" style="text-align: center;font-size:2rem"
            >Best Deal</span>
        <h2 class="section__title" style="text-align: center; font-size:3rem">
            Our Packet
        </h2>
                        ...
                        <a href="{{ route('paket', $d->id) }}">
                            ...
                            <div class="popular__data">
                                <h2 class="popular__price">
                                    <span>Rp.</span>{{' ' .number_format($d->harga_paket,2) }}
                                </h2>
                                <h3 class="popular__title">
                                    {{ $d->fpaket->nama_paket}}
                                </h3>
                                <p class="popular__description">{{ $d->fpaket->deskripsi}}</p>
                            </div>
                        </a>
                    </article>
