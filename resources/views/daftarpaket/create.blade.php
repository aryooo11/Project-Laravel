...
@section('content_header')<h1 class="m-0 text-dark">Tambah Daftar Paket</h1>
@stop
@section('content')
...
@error('nama_paket') is-invalid @enderror" id="nama_paket" placeholder="Daftar Paket" name="nama_paket"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control 
@error('id_paket_wisata') is-invalid @enderror" placeholder="Paket Wisata" id="paket_wisata" name="paket_wisata" value="{{old('paket_wisata')}}"
