  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop " data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">yo</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
             ...
             <form class="ps-lg-5" >
                <a class="btn btn-lg btn-white hover-top btn-outline-warning order-0" href="{{ route('login') }} " role="button">Log In</a>
                @if (Route::has('register'))
            <form class="ps-lg-5">
              <a class="btn btn-lg btn-white hover-top btn-outline-primary order-0" href="{{ route('register') }} " role="button">Sign Up</a>
            {{-- </form> --}}
             @endif
             @endauth
            </form>
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              ...
              <p class="mt-4 mb-5 fs-1 lh-base">Plan and book your perfect trip with expert advice, <br class="d-none d-lg-block" />travel tips, destination information and <br class="d-none d-lg-block" />inspiration from us.</p><a class="btn btn-lg btn-primary hover-top" href="{{ url('reservasi/create') }} " role="button">Book Now</a>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="carousel slide" id="carouselExampleControlsNoTouching" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="storage/{{$data->fwis->foto1}}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">{{ 'Rp.'.' '.$data->harga }}</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">{{ $data->fwis->nama_paket }}</h5>
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="storage/{{ $data->fwis->foto2 }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="storage/{{ $data->fwis->foto3 }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="storage/{{ $data->fwis->foto4 }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">$340</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="storage/{{ $data->fwis->foto5 }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                      ...
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img  class="img-thumbnail" width="150" height="50" src="storage/{{ $p->foto }}" alt="" /></div>
                          </div>
                          <div class="mt-3 text-center">
                            <h6 class="text-1000 fw-bold">{{ $p->nama_lengkap }}</h6>
            ...
            <div class="col-12 py-8 text-white">
              ...
              <form class="row gy-2 gx-md-2 gx-lg-4 flex-center my-6">
                ...
                <div class="col-6 col-md-auto">
                  <a class="btn btn-lg btn-primary hover-top" href="{{ route('home') }} " role="button">Book Now</a>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <ul class="list-unstyled list-inline mb-0">
                <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="{{ url('/home') }}">Home</a></li>
