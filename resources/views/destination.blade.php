        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              <h1 class="mb-4 display-1 lh-sm">Daftar Paket <br class="d-block d-lg-none d-xl-block" /></h1>
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-lg-8 text-center">
                <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Daftar Paket Tujuan</h1>
              <hr class="text-primary my-4 my-lg-3 my-xl-4" style="height:3px; width:950px;" />
            </div>
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              ...
              <p class="lh-lg">Etiam facilisis, sapien quis porta dignissim, orci nisi pharetra dui, varius vehicula ligula nulla sit amet lorem. Aenean in vestibulum quam. Cras commodo varius neque, non gravida diam ultrices nec. Cras nulla mauris, fermentum nec libero in.</p>
                                ...
                                <div class="swiper-wrapper">
                                    @foreach($destination as $d)
                                        <article class="popular__card swiper-slide">
                                            <a href="{{ route('paket', $d->id) }}">
                                                <img
                                                    src="storage/{{ $d->fpaket->foto1 }}"
                                                    alt=""
                                                    class="popular__img"
                                                />
                                                <div class="popular__data">
                                                    <h2 class="popular__price">
                                                        <span>Rp.</span>{{ number_format($d->harga_paket) }}
                                                    </h2>
                                                    <h3 class="popular__title">
                                                        {{ $d->nama_paket}}
                                                    </h3>
                                                    <p class="popular__description">{{ $d->fpaket->fasilitas }}</p>
                                                </div>
                                            </a>
                                        </article>
                                    @endforeach
